...
<h5 style="color: green;">BILLING DETAILS</h5>
<hr>
...
<div class="col-md-6">
    ...
    <input type="text" style="" class="form-control form-control-lg text-muted border-secondary rounded-1" name="fname" id="fname">
    <p class="text-danger fname"></p>
</div>
<div class="col-md-6">
    <label for="" class="form-label" style="color: #7f8b92; font-family: Calibri;" >Last Name </label>
    <input type="text" class="form-control form-control-lg  text-muted border-secondary rounded-1" style="" name="lname" id="lname">
    <p class="text-danger lname"></p>
</div>
<div class="col-md-12">
    <label for="" class="form-label" style="color: #7f8b92; font-family: Calibri;"  >Company name (optional)</label>
    <input type="text" class="form-control form-control-lg  text-muted border-secondary rounded-1" style="" name="company" id="company"> 
    <p class="text-danger company"></p>   
</div>
<div class="col-md-12">
    <label for="" class="form-label" style="color: #7f8b92; font-family: Calibri;" >Country / Region</label>
    <select class="form-select form-control-lg  text-muted border-secondary rounded-1" style="" name="country" id="country">
...
<div class="col-md-12">
    ...
    <input type="text" class="form-control form-control-lg  text-muted border-secondary rounded-1" style="" name="address" id="address">  
    <p class="text-danger address"></p>  
</div>
<div class="col-md-12">
    <label for="" class="form-label" style="color: #7f8b92; font-family: Calibri;">Town / City (optional)</label>
    <input type="text" class="form-control form-control-lg  text-muted border-secondary rounded-1" style="" name="city" id="city">
    <p class="text-danger city"></p>
</div>   
<div class="col-md-12">
    <label for="" class="form-label" style="color: #7f8b92; font-family: Calibri;">Postcode / ZIP</label>
    <input type="text" class="form-control form-control-lg text-muted border-secondary rounded-1" style="" name="zip" id="zip">
    <p class="text-danger zip"></p>
</div> 
<div class="col-md-12">
    <label for="" class="form-label" style="color: #7f8b92; font-family: Calibri;">Phone</label>
    <input type="text" class="form-control form-control-lg text-muted border-secondary rounded-1" style="" name="phone" id="phone">
    <p class="text-danger phone"></p>
</div> 
<div class="col-md-12">
    <label for="" class="form-label" style="color: #7f8b92; font-family: Calibri;">Email Address</label>
    <input type="text" style="font-family: Calibri;" class="form-control form-control-lg  text-muted border-secondary rounded-1 text-dark" value="<?php echo $userEmail ?>"  name="email" id="email">
...
<!--- your orders-->
  <div class="col-md-6 p-3">
  <h5 style="color:green;" class="">YOUR ORDERS</h5>
  <hr>
 ...
 <table class="table table-borderless">
   ...
   <?php
     ...
     while($row = mysqli_fetch_assoc($result)){
      ...
      <tbody>
        <tr>
           <td><p class=" text-dark mt-3 px-3 mb-1" style="font-family: Calibri;"><?php echo $row['name'];?></p></td>
           <td><p class="mt-3 px-3" align="right" style="color: orange;"><span>$</span><?php echo $row['price'];?></p></td>
        </tr>
      </tbody>
      ...
      <tbody>
        <tr>
        <td><p class="px-3 mt-0 text-info" style="font-family: Calibri;"><?php echo $row['brand'];?></p></td>
        </tr>
      </tbody>
   <?php
     }
   ...
   <tbody>
    ...
    <tbody>
        <tr>
          <th><h5 class="mt-5" style="font-family: Calibri; color: #000;">Credit Card | Debit Card | PayPal</h5></th>
        </tr>
    </tbody> 

    <tbody>
       <tr>
         <td colspan="2"><p style="font-family: Calibri; font-size:18px; color:#000;">To "Continue to payment" I acknowledge I have read and agreed to<br>
